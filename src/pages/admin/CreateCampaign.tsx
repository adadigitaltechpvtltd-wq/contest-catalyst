...
const CreateCampaign = () => {
  ...
  const handleCropComplete = useCallback(async (croppedFile: File) => {
    ...
    const fileName = `contest-new-${Date.now()}.${fileExt}`;
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Card className="glass-card mb-6">
          <CardHeader>
            ...
            <CardDescription>Choose whether participants submit photos or videos (reels)</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                onClick={() => setCampaignType('photo')}
