...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden py-16 lg:py-24">
      {/* Decorative cubes */}
      <div className="absolute top-20 right-[15%] w-16 h-16 md:w-24 md:h-24 rounded-2xl bg-gradient-to-br from-primary to-primary/80 animate-float shadow-glow" />
      <div className="absolute top-40 right-[8%] w-10 h-10 md:w-14 md:h-14 rounded-xl bg-gradient-to-br from-secondary to-secondary/80 animate-float-reverse" />
      <div className="absolute top-32 right-[5%] w-6 h-6 md:w-8 md:h-8 rounded-lg bg-primary/60 animate-float" style={{ animationDelay: '0.5s' }} />
              ...
              <div className="flex items-center gap-2 flex-1">
                {[
                  ...
                  <div key={item.label} className="text-center">
                    <div className="w-10 h-10 rounded-lg bg-background flex items-center justify-center font-display font-bold text-foreground">
                      {item.value}
                    </div>
